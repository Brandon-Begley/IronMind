  ...
  Widget build(BuildContext context) => GestureDetector(
    ...
    child: Container(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        if (sub != null) Text(sub!, style: GoogleFonts.dmMono(color: IronMindTheme.text3, fontSize: 9)),
      ]),
    ),
  );
}
  ...
  Widget build(BuildContext context) => Center(
    child: Padding(
      ...
      child: Column(mainAxisSize: MainAxisSize.min, children: [
        ...
        Text(title.toUpperCase(), style: GoogleFonts.bebasNeue(color: IronMindTheme.text3, fontSize: 18, letterSpacing: 2)),
        const SizedBox(height: 4),
        Text(sub, style: GoogleFonts.dmMono(color: IronMindTheme.text3, fontSize: 11), textAlign: TextAlign.center),
      ]),
    ),
  );
}
