  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        leading: isModal
            ? IconButton(icon: const Icon(Icons.close, color: IronMindTheme.text2), onPressed: () => Navigator.pop(context))
            : null,
                ...
                Padding(
                  ...
                  child: Center(
                    child: Text(
                      ...
                      style: GoogleFonts.dmSans(color: IronMindTheme.accent, fontSize: 13, fontWeight: FontWeight.w600),
                    ),
                  ),
                ),
              ]
        ...
        Column(children: [
              ...
              Expanded(child: TextField(
                ...
                decoration: InputDecoration(
                  ...
                  suffixIcon: _searchCtrl.text.isNotEmpty
                      ? GestureDetector(
                          onTap: () { _searchCtrl.clear(); _loadExercises(reset: true); },
                          child: const Icon(Icons.close, color: IronMindTheme.text3, size: 18))
                      : null,
                ),
              ...
              child: Column(children: [
                SizedBox(height: 36, child: ListView(
                  ...
                  children: [
                    ...
                    ..._bodyParts.map((bp) => _FilterChip(
                      ...
                      () {
                        setState(() { _selectedBodyPart = _selectedBodyPart == bp ? '' : bp; _selectedEquipment = ''; });
                        _loadExercises(reset: true);
                      },
                    )),
                  ],
                ...
                SizedBox(height: 32, child: ListView(
                  ...
                  children: _equipment.map((eq) => _FilterChip(
                    ...
                    () {
                      setState(() { _selectedEquipment = _selectedEquipment == eq ? '' : eq; _selectedBodyPart = ''; });
                      _loadExercises(reset: true);
                    },
                    small: true,
                  )).toList(),
          ...
          Expanded(
            child: _exercises.isEmpty && !_loading
                ...
                : ListView.builder(
                    padding: EdgeInsets.fromLTRB(16, 12, 16, _selected.isNotEmpty ? 100 : 24),
                    ...
                    itemBuilder: (ctx, i) {
                          ...
                          child: Center(child: _loading
                              ...
                              : OutlinedButton(
                                  ...
                                  style: OutlinedButton.styleFrom(
                                      ...
                                      side: BorderSide(color: IronMindTheme.accent.withOpacity(0.3))),
                      ...
                      return _ExerciseCard(
                        ...
                        onToggle: isModal ? () => _toggleSelection(name) : null,
                        onAddMultipleToWorkout: widget.onAddMultipleToWorkout,
                      );
                    },
                  ),
          ),
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(
            color: isSelected
                ? IronMindTheme.accent.withOpacity(0.6)
            ...
            child: Container(
              ...
              child: gifUrl != null
                  ? Image.network(gifUrl, fit: BoxFit.cover,
                      errorBuilder: (_, __, ___) => const Icon(Icons.fitness_center, color: IronMindTheme.text3, size: 24))
                  : const Icon(Icons.fitness_center, color: IronMindTheme.text3, size: 24),
            ),
          ),
          ...
          Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            Text(
              ...
              style: GoogleFonts.dmSans(
                color: isSelected ? IronMindTheme.accent : IronMindTheme.textPrimary,
          ...
          if (isSelectMode)
            AnimatedContainer(
              ...
              decoration: BoxDecoration(
                ...
                borderRadius: BorderRadius.circular(8),
                border: Border.all(
                  color: isSelected ? IronMindTheme.accent : IronMindTheme.border2,
                  width: 1.5,
                ),
              ),
              ...
              child: isSelected
                  ...
                  : const Icon(Icons.add_rounded, color: IronMindTheme.text3, size: 18),
            )
          else
...
class _ExerciseDetailScreen extends StatelessWidget {
  final Map<String, dynamic> exercise;
  final Function(List<String>)? onAddMultipleToWorkout;
  const _ExerciseDetailScreen({required this.exercise, this.onAddMultipleToWorkout});
